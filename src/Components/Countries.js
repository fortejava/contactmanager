...
export class Countries extends Component 
{
    ...
    getData = () => {
        ...
        fetch('http://contactmanager.business-specialist.tk/services/getCountries.php')
          .then(response => {
    ...
    createCountry = (evt) => {
        ...
        fetch("http://contactmanager.business-specialist.tk/services/countryAdd.php",
        {
            method: "POST",
    ...
    countryNameChange = (evt) => {
        ...
        let nextCountryFormData = JSON.parse(JSON.stringify(this.state.countryFormData));
    ...
    {
        console.log("id del paese da eliminare: " + countryId);
        fetch(
    ...
    render() 
    {
        ...
        return (
             <React.Fragment>
                        ...
                        <Row>
                            <Col xs="12" sm="6">
                                <FormGroup>
                                    ...
                                    <Input type="select" name="countryArea" id="countryArea" onChange={this.countryAreaChange}>
                                        <option value="Europa" selected>Europe</option>
                ...
                <CountriesList countriesList={this.state.countriesData} onDelete={this.deleteCountry} onCountryUpdate={this.getData} />
